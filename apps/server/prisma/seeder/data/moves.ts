import { kebabToCamelCase } from '@common/helpers/pokemon.helper';
      ...
      return {
        ...
        type:
          move.type.name === 'fairy'
            ? TypeNames.normal
            : (move.type.name as TypeNames), // INFO: only 3: https://bulbapedia.bulbagarden.net/wiki/List_of_modified_moves#Generation_IV_to_Generation_V_4
      };
    });
