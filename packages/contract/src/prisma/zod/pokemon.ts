...
import { TypeNames, TypeNames, Gender, Tier } from "@prisma/client"
import { CompleteType, RelatedTypeModel, CompleteSlot, RelatedSlotModel, CompleteAbility, RelatedAbilityModel, CompleteMove, RelatedMoveModel } from "./index"
 ...
 */
export const RelatedPokemonModel: z.ZodSchema<CompletePokemon> = z.lazy(() => PokemonModel.extend({
